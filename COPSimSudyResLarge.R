...
#               samples. Estimates for the copula dependence parameter theta 
#               were obtained using ML, the inversion of Kendall's tau, and a
#               p-value weighted average of the two in combination with the
#               Frank, the Gumbel, and the Clayton copula. The true copula 
#               is indicated by the name of each data matrix. Standard 
#               deviations are given in the lines below the respective values.
# ------------------------------------------------------------------------------
# Usage:        -
# ------------------------------------------------------------------------------
# Inputs:       ResFrankLarge0.25.txt,   ResFrankLarge0.5.txt,
